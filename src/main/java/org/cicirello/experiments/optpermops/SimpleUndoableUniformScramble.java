 ...
 */
public final class SimpleUndoableUniformScramble
   ...
   *     equal to 1.0.
   */
  public SimpleUndoableUniformScramble(double u) {
    this(u, false);
  }
   ...
   *     equal to 1.0.
   */
  public SimpleUndoableUniformScramble(double u, boolean guaranteeChange) {
  ...
  private SimpleUndoableUniformScramble(SimpleUndoableUniformScramble other) {
  ...
  @Override
  public SimpleUndoableUniformScramble split() {
    return new SimpleUndoableUniformScramble(this);
  }
