...
/**
 * Experiment comparing CPU time of two alternative UPMX implementations.
 *
 * @author <a href=https://www.cicirello.org/ target=_top>Vincent A. Cicirello</a>, <a
 *     href=https://www.cicirello.org/ target=_top>https://www.cicirello.org/</a>
 */
public class ExperimentUPMX {
  ...
  public static void main(String[] args) {
    ...
    for (double u : rates) {
      SimpleUPMX simple = new SimpleUPMX(u);
      UniformPartiallyMatchedCrossover optimized = new UniformPartiallyMatchedCrossover(u);
