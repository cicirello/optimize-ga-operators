...
/**
 * Experiment comparing CPU time of two alternative GAs: typical implementation of bit flip mutation
 * and generation loop; vs optimized version where binomial is used for choosing which bits to
...
public class GAExperiment2 {
  ...
  public static void main(String[] args) {
    ...
    ArrayList<CrossoverOperator<BitVector>> xover = new ArrayList<CrossoverOperator<BitVector>>();
    xover.add(new SinglePointCrossover());
    ...
    for (CrossoverOperator<BitVector> crossover : xover) {
    ...
    for (CrossoverOperator<BitVector> crossover : xover) {
      System.out.printf("%s%n", crossover.getClass().getSimpleName());
      System.out.printf(
